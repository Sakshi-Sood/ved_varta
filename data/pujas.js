export const pujasData = [
  ...
  },
  {
    ...
    items_included: [
      ...
      "Yellow cloth and turmeric",
      "Sacred story recitation",
      "Prasad distribution"
    ],
    price: {
      basic: "₹2,800",
    ...
    occasions: ["Wish fulfillment", "Family ceremonies", "Prosperity prayers", "Regular worship"],
    popular: true
  },
  {
    id: 3,
  ...
  },
  {
    ...
    items_included: [
      "11 different abhishek materials",
      "Rudraksha and Bel leaves",
...
export const pujaCategories = [
  { name: "All Pujas", value: "all" },
  { name: "Spiritual", value: "Spiritual" },
  { name: "Prosperity", value: "Prosperity" },
  ...
  { name: "Ceremonies", value: "Ceremonies" }
];

export const pujaFeatures = [
  {
    title: "Authentic Rituals",
    description: "Traditional Vedic procedures followed with precision",
    icon: "🕉️"
  },
  {
    title: "Experienced Pandits",
    description: "Certified and experienced priests perform all rituals",
    icon: "👨‍🏫"
  },
  {
    title: "Quality Materials",
    description: "Premium quality puja materials and offerings",
    icon: "🌸"
  },
  {
    title: "Customized Service",
    description: "Personalized puja based on your specific needs",
    icon: "⭐"
  },
  {
    title: "Home Service",
    description: "Convenient puja service at your home or office",
    icon: "🏠"
  },
  {
    title: "Live Streaming",
    description: "Watch your puja live if you can't attend in person",
    icon: "📱"
  }
];