...
const AboutPage = () => {
  ...
  const qualifications = [
    {
      title: "Ph.D. in Jyotish Shastra from Banaras Hindu University",
      verified: true
    },
    {
      title: "M.A. in Sanskrit Literature with specialization in Astrology",
      verified: true
    },
    {
      title: "Diploma in Vastu Shastra from Indian Institute of Astrology",
      verified: true
    },
    {
      title: "Advanced Certificate in Gemology from Gemological Institute",
      verified: true
    },
    {
      title: "Traditional Gurukul training under renowned Acharya Pt. Vishnu Sharma",
      verified: true
    },
    {
      title: "15+ years of practical experience in Vedic consultation",
      verified: true
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-100 via-orange-100 to-amber-100">
      {/* Hero Section */}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-8">
              ...
              <div className="text-center mb-6">
                <div className="relative w-32 h-32 mx-auto mb-4">
                  <div className="w-full h-full bg-gradient-to-br from-orange-400 to-amber-500 rounded-full flex items-center justify-center text-white text-4xl font-bold border-4 border-orange-200">
                    <Image
                      src="/acharyaAnoop.jpg"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {expertiseAreas.map((area, index) => (
                  <div key={index} className="bg-orange-50 rounded-xl p-6 text-center border border-orange-300 hover:shadow-lg hover:border-orange-500 transition-all duration-300">
                    <div className="text-4xl mb-4">
                        <Image src={area.icon} alt={`${area.title} Icon`} width={32} height={32} className="w-8 h-8 mx-auto" />
                    </div>
