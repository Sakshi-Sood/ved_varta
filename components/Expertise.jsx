...
const Expertise = () => {
  return (
    <section id="services" className="px-3 sm:px-10 lg:px-44">
      ...
      <div className="bg-transparent py-4 sm:py-6 lg:py-8 max-w-[90rem] mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 cursor-default">
          {expertiseAreas.map((area, index) => (
            <div
              key={index}
              className="bg-yellow-50/90 hover:bg-amber-100/90 rounded-lg p-3 flex items-center gap-2 sm:gap-4 border border-orange-200 hover:shadow-md hover:border-orange-300 hover:scale-105 transition-all duration-300"
            >
